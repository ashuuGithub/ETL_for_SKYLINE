...
def main():
    ...
    view_name = 'student'  # SQL Server view name
    table_name = 'student_view'  # MySQL table name
    sql_columns = [
        'endYear', 'districtID', 'calendarID', 'personID', 'structureID', 'noShow', 'schoolID', 
        'enrollmentID', 'schoolOfAccountability', 'stateID', 'otherID', 'additionalID', 'edFiID', 
        'studentNumber', 'personGUID', 'identityID', 'effectiveDate', 'lastName', 'firstName', 
        'middleName', 'suffix', 'alias', 'gender', 'birthdate', 'ssn', 'legalFirstName', 
        'legalLastName', 'legalMiddleName', 'legalSuffix', 'legalGender', 'pronounID', 
        'raceEthnicity', 'hispanicEthnicity', 'raceEthnicityFed', 'raceEthnicityDetermination', 
        'birthCountry', 'birthState', 'birthCity', 'birthCounty', 'homePrimaryLanguage', 
        'languageAlt', 'languageAlt2', 'languageAlt3', 'languageAlt4', 'grade', 'serviceType', 
        'startDate', 'startStatus', 'endDate', 'endStatus', 'enrollmentStateExclude', 
        'calendarName', 'calendarStart', 'calendarEnd', 'calendarExclude', 'startYear', 'label', 
        'activeYear', 'stateGrade', 'gradeLevelExcludeState', 'gradeLevelExcludeGPA', 'sifExclude', 
        'excludeFromSIF', 'modifiedDate', 'externalLMSExclude', 'crossSiteEnrollment', 'immigrant', 
        'refugee'
    ]
    mysql_columns = [
        'endYear', 'districtID', 'calendarID', 'personID', 'structureID', 'noShow', 'schoolID', 
